...
#SBATCH -J "rsl"   # job name

## /SBATCH -p general # partition (queue)
#SBATCH -o rsl-slurm.%N.%j.out # STDOUT
#SBATCH -e rsl-slurm.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:261884442570:awsnotify --message "RSLJobDone"
